...
//        openCameraIntent();
        ...
        toast.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedId==-1){
                    Toast.makeText(SelectLanguage.this,"Nothing selected", Toast.LENGTH_SHORT).show();
                }
                else{
                    //System.out.println(genderradioButton.getText().toString());
                    openCameraIntent();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == REQUEST_IMAGE && resultCode == RESULT_OK) {
            try {
                ...
                Crop.of(source_uri, dest_uri).asSquare().start(SelectLanguage.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        // if cropping acitivty is finished, get the resulting cropped image uri and send it to 'Classify' activity
            ...
            Intent i = new Intent(SelectLanguage.this, Classify.class);
            ...
            lang=genderradioButton.getText().toString();
//            Toast.makeText(SelectLanguage.this,genderradioButton.getText().toString(), Toast.LENGTH_SHORT).show();
//            Intent intent=new Intent(SelectLanguage.this,Classify.class);
            Log.d("TEST", lang);
